...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full min-h-[calc(100vh-80px)] flex flex-col justify-between bg-background overflow-hidden border-b border-primary/20">
      ...
      {/* Main Content */}
      <div className="container-custom relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-start pt-12 lg:pt-2 pb-6 flex-grow">
        {/* Left: Text & Actions */}
        <motion.div
        ...
        >
          ...
          <motion.h1
            variants={fadeUp}
            className="text-4xl md:text-5xl lg:text-[64px] leading-[1.1] font-bold text-white font-heading"
          >
          ...
          <motion.p
            variants={fadeUp}
            className="text-text-light text-base md:text-lg max-w-xl leading-relaxed"
          >
          ...
          <motion.div
            variants={fadeUp}
            className="grid grid-cols-2 sm:grid-cols-3 gap-3 mt-6 border-t border-white/10 pt-8 w-full max-w-2xl"
          >
        ...
        <motion.div
          ...
          className="relative w-full max-w-lg mx-auto lg:ml-auto lg:mr-0 h-[400px] lg:h-[500px] -mt-6 lg:-mt-12"
        >
          {/* Bobbing Container */}
          <motion.div
            animate={{ y: [0, -20, 0] }}
          ...
          >
            ...
            <img
              src="https://plus.unsplash.com/premium_photo-1683120793196-0797cec08a7d?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        ...
        <div className="container-custom py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 divide-x divide-white/20">
            {[
              ...
              <div
                key={index}
                className={`flex flex-col items-center justify-center text-center ${index !== 0 ? "pl-6" : ""}`}
              >
