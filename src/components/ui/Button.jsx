...
export default function Button({
  ...
  return (
    <button
      ...
      className={clsx(
        "group relative isolate overflow-hidden inline-flex items-center justify-center",
        "font-semibold tracking-wide",
        "transition-all duration-500 ease-[cubic-bezier(.19,1,.22,1)]",
        "translate-y-0",
        // "shadow-[0_6px_0_0_rgb(0,145,60)]",
    ...
    >
      ...
      <span className="absolute inset-0 rounded-inherit border border-white/10 transition-colors duration-500 group-hover:border-white/20" />
